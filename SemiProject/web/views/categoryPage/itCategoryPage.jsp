	...
	<div class="section2">
			<div class="sbody">
				<div class="cb1" style="width:18%" >
					<h1 style="font-size:23px;">IT/프로그래밍</h1>		
				</div>
				...
				<div class="cb2" style="width:50%;"> 
					...
					<%} %>
					<h3 style="font-size:15px;display:inline-block;"><a href="/semi/selectList.bo?cate=itCategoryPage">IT/프로그래밍</a></h3>		
				</div>
