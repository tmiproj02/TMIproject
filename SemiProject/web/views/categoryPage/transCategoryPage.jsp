	...
	<div class="section2">
			<div class="sbody">
				<div class="cb1" style="width:18%" >
					<h1 style="font-size:25px;">번역/통역</h1>		
				</div>
				...
				<%} %>
					<h3 style="font-size:15px;display:inline-block;"><a href="/semi/selectList.bo?cate=transCategoryPage">번역/통역</a></h3>		
				</div>
			...
			<div class="scontent">
				...
				<div class="paging">
				  ...
				  <a href="<%=request.getContextPath()%>/selectList.bo?currentPage=1&cate=transCategoryPage" class="btn_arr first"><span class="hide">처음페이지</span></a>
				  <%if(currentPage<=1){ %>
				  	<a class="btn_arr prev"><span class="hide">이전페이지</span></a>  
				  <%} else{ %>          
				  	<a href="<%= request.getContextPath() %>/selectList.bo?currentPage=<%=currentPage - 1 %>&cate=transCategoryPage" class="btn_arr prev"><span class="hide">이전페이지</span></a>  
				  <%} %>   
				  <%for(int p = startPage; p <= endPage; p++){
					...
					%>
				  	<a class="on"><%= p %></a>
				  	<%}else{ %>
				  	<a href="<%=request.getContextPath()%>/selectList.bo?currentPage=<%=p%>&cate=transCategoryPage"><%=p%></a>
				  	<%}
				  	}	
				  	%>
				  ...
				  <%}else{ %>
				 	<a href="<%= request.getContextPath() %>/selectList.bo?currentPage=<%=currentPage + 1 %>&cate=transCategoryPage" class="btn_arr next"><span class="hide">다음페이지</span></a> 
				  <%} %>           
				  <a href="<%=request.getContextPath()%>/selectList.bo?currentPage=<%=maxPage %>&cate=transCategoryPage" class="btn_arr last"><span class="hide">마지막페이지</span></a>
