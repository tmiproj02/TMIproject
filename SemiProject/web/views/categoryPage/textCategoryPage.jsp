	...
	<div class="section2">
			<div class="sbody">
				<div class="cb1" style="width:18%" >
					<h1 style="font-size:25px;">문서/취업</h1>		
				</div>
				...
				<div class="cb2" style="width:50%;"> 
					...
					<%} %>
					<h3 style="font-size:15px;display:inline-block;"><a href="/semi/selectList.bo?cate=textCategoryPage">문서/취업</a></h3>		
				</div>
			...
			<div class="scontent">
				...
				<div class="paging">
				  ...
				  <a href="<%=request.getContextPath()%>/selectList.bo?currentPage=1&cate=textCategoryPage" class="btn_arr first"><span class="hide">처음페이지</span></a>
				  <%if(currentPage<=1){ %>
				  	<a class="btn_arr prev"><span class="hide">이전페이지</span></a>  
				  <%} else{ %>          
				  	<a href="<%= request.getContextPath() %>/selectList.bo?currentPage=<%=currentPage - 1 %>&cate=textCategoryPage" class="btn_arr prev"><span class="hide">이전페이지</span></a>  
				  <%} %>   
				  <%for(int p = startPage; p <= endPage; p++){
					...
					%>
				  	<a class="on"><%= p %></a>
				  	<%}else{ %>
				  	<a href="<%=request.getContextPath()%>/selectList.bo?currentPage=<%=p%>&cate=textCategoryPage"><%=p%></a>
				  	<%}
				  	}	
				  	%>
				  ...
				  <%}else{ %>
				 	<a href="<%= request.getContextPath() %>/selectList.bo?currentPage=<%=currentPage + 1 %>&cate=textCategoryPage" class="btn_arr next"><span class="hide">다음페이지</span></a> 
				  <%} %>           
				  <a href="<%=request.getContextPath()%>/selectList.bo?currentPage=<%=maxPage %>&cate=textCategoryPage" class="btn_arr last"><span class="hide">마지막페이지</span></a>
