        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="memberManage.jsp" class="site_title"><i class="fa fa-paw"></i> <span>TMI Corporation</span></a>
            </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li><a href="memberManage.jsp"><i class="fa fa-users"></i>회원 관리 </a></li>
                  ...
                  <li><a><i class="fa fa-comment"></i> 1:1 문의(UI Elements) <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="general_elements.html">General Elements</a></li>
                      <li><a href="media_gallery.html">Media Gallery</a></li>
                      <li><a href="memberRequest.jsp">1:1 문의(클론)</a></li>
