...
<body>
 ...
 -->
  ...
  <tbody>
    <tr>
      <th scope="row"><label style="display: block;"> <input type="radio" name="cPrice" value="100">
								<div class="awesome-radio-text" style="display: inline; padding-right: 300px;">
									<b class="priceNum"><i class="won sign icon"></i>10,000</b> &nbsp;&nbsp;
								</div>
							</label></th>
...
<div class="cashPriceCheck" >
				...
				<div class="wPrice">
					...
					<p style="text-align:right; display:inline;" class="pricewon">
						0</p>
					<span style="text-align:right; display:inline;">원</span>
					<p style="padding-left:40px;"><i class="plus icon"></i>충전 혜택</p>
					<p style="text-align:right;"><i class="won sign icon"></i>0원</p>
				
				<p style="padding-left:20px; display: inline;">총 충전 금액</p><i class="won sign icon"></i>
				<p style="text-align:right; display:inline;" class="pricewon">0</p>
				...
				<br>
				<i class="won sign icon"></i>
				<p style="font-size: 20px; color: red; text-align:right; font-weight: bold; display: inline-block;" class="pricewon">
					0
				</p>
				<span style="font-size: 20px; color: red; text-align:right; font-weight: bold; display: inline-block;">원</span>
   ...
   <div class="ui vertical divider">★</div>
	...
	<div class="refunding-box">
		<h4><i class="exclamation triangle icon"></i>TMI 캐시 안내</h4>
		<p style="margin-left:20px;">TMI 캐시는 충전캐시와 적립캐시가 있습니다.</p>
		<div class="ref-info">
		<ul padding-left="0%">
			<li style="font-weight:bolder">충전캐시</li>
				<div class="refungding1" style="margin-left:15px; border:1px solid yellowgreen;">
				<ol>
			...
			<li style="font-weight:bolder">적립캐시</li>
				<div class="refunding2" style="margin-left:15px; border:1px solid yellowgreen;">
				<ol>
		...
		<table style="display:none;"> <!-- 결제 정보에 사용-->
			<tr>
