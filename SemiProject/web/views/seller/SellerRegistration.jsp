...
<form action="/semi/views/seller/SellerComplete.jsp" method="post" style="margin-top:100px;">
	...
	<div id="regist" class="jumbotron" style = "position: absolute; top:10%;left:20%; width:800px; height:auto;" align="center">
		...
		<div class="ui two column very relaxed grid">
			...
			<div class="column">
			    ...
			    <div class="ui input focus">
					<input type="text" placeholder="-없이 입력" value="">
				</div>
				...
				<div class="inline field">
					<textarea rows="2" placeholder="간단하게 자기소개를 해주세요~" style="width:280px; height:80px;"></textarea>
				</div>
			</div>
		</div>
		</div>
	...
	<table class="table table-hover">
		...
		<tbody>
			<tr>
				<td>
					<div class="ui input focus">
					<input type="text" placeholder="예) 2019/01/01~2019/12/31" value="" style="width:230px; height:30px;">
					</div>
				</td>
				<td>
					<div class="ui input focus">
					<input type="text" placeholder="예) 주식회사 TMI" value="" style="width:230px; height:30px;">
					</div>
				</td>
			</tr>
			<tr>
	...
	<table class="table table-hover">
		...
		<tbody>
			<tr>
				<td>
					<div class="ui input focus">
					<input type="text" placeholder="예) 정보처리기사" value="" style="width:230px; height:30px;">
					</div>
				</td>
			</tr>
			<tr>
				<td>
					<div class="ui input focus">
					<input type="text" placeholder="예) 컴퓨터 활용능력 1급" value="" style="width:230px; height:30px;">
					</div>
				</td>
			</tr>
			<tr> 
	...
	<div id="account" class="jumbotron" style = "position: absolute; top:10%;left:20%; width:800px; height:auto;" align="center" hidden>
		...
		<div class="column">
			...
			<div class="form-row align-items-center">
				...
				<div>
					...
					<div class="ui input focus">
						&nbsp;
						<input type="text" placeholder="-없이 입력해 주세요" value="">
					</div>
				</div>
				<br>
				<div>
