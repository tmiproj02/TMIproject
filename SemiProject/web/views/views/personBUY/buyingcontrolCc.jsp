...
ArrayList<DealMng> ccList = (ArrayList<DealMng>)request.getAttribute("ccList"); 

int s1 = 0;
int s2 = 0;
int s3 = 0;

for(DealMng d : ccList){
			...
			<div class="scontainer3 width-75per" style="float:left">
				...
				<div style="margin-top:20px">
					<div class="padding-15">
						<ul class="sell-ing">
							<li>
								<a style="cursor:pointer" onclick="nrequest();">전체내역 &nbsp; <span class="selling-history">0</span></a>
							</li>
							<li>
							...
							<li>
								<a style="color:#000; cursor:pointer;" onclick="cclist();">취소 &nbsp; <span class="selling-history select"><%=s3 %></span></a>
							</li>
						</ul>
					</div>
				</div>
					...
					<div class="padding-15" style="margin-top:10px">
						...
						<% if (ccList.size()==0) { %>
							...
							<!-- 내역이 있을 때 -->
							<div class="tableArea">
							<%  for(DealMng dm : ccList) { %>
								<table align="center" id="listArea">
									<tr>
										<th class="bcthumb"><img src="/semi/resources/images/noun_cancel.png" width="80px;"></th>
