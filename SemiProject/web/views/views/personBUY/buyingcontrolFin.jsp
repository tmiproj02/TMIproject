...
ArrayList<DealMng> finList = (ArrayList<DealMng>)request.getAttribute("finList"); 
int s1 = 0;
int s2 = 0;
int s3 = 0;

for(DealMng d : finList){
			...
			<div class="scontainer3 width-75per" style="float:left">
				...
				<div style="margin-top:20px">
					<div class="padding-15">
						<ul class="sell-ing">
							<li>
								<a style="cursor:pointer" onclick="nrequest();">전체내역 &nbsp; <span class="selling-history"><%=s1 %></span></a>
							</li>
							<li>
								<a style="cursor:pointer;" onclick="prging();">진행중 &nbsp; <span class="selling-history"><%=s2 %></span></a>
							</li>
							<li>
								<a style="color:#000; cursor:pointer;" onclick="finlist();">완료 &nbsp; <span class="selling-history select"><%=finList.size() %></span></a>
							</li>
							<li>
					...
					<div class="padding-15" style="margin-top:10px">
						...
						<% if (finList.size()==0) { %>
							...
							<!-- 내역이 있을 때 -->
							<div class="tableArea">
							<%  for(DealMng dm : finList) { %>
								<table align="center" id="listArea">
									<tr>
										<th class="bcthumb"><img src="/semi/resources/images/noun_available.png" width="80px;"></th>
