...
<%  ArrayList<Cash> rcgOnlyList = (ArrayList<Cash>)request.getAttribute("rcgOnlyList");
	System.out.println("billingHistory:"+rcgOnlyList); 
	...
	<div class="my-page-buy">
		<div class="scontainer">
			...
			<div class="scontainer3 width-75per padding-15" style="float:left">
				<div class="padding-15">
					<h3 class="font-noto" style="font-weight:700; margin-top:3%;">충전내역</h3>
				</div>
