<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@ page import="java.util.*, member.model.vo.*, buyingctrl.model.vo.*" %>
<% 
				...
				<div style="margin-top:20px">
					<div class="padding-15">
						<ul class="sell-ing">
							...
							<li>
								<a style="color:#000; cursor:pointer;" onclick="prging();">진행중  &nbsp; <span class="selling-history select"><%=dingList.size() %></span></a>
						...
						<% } else {%>		
							...
							<%  for(DealMng dm : dingList) { %>
								<table align="center" id="listArea">
									<tr>
										<th class="bcthumb"><img src="/semi/resources/images/noun_loading.png" width="80px;"></th>
